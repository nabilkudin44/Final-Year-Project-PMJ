...
<div class="app-shell">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="aduan.php" class="nav-item <?= navActiveT('aduan.php') ?>">
                <i class="fas fa-comment-dots"></i><span>Aduan</span>
            </a>
            <a href="dokumen.php" class="nav-item <?= navActiveT('dokumen.php') ?>">
